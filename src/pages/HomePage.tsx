        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link to="/campaigns" className="text-gray-600 hover:text-blue-600 transition-colors">
                Browse Campaigns
              </Link>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link to="/start-campaign" className="hover:text-white transition-colors">
                    Start Campaign
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link to="/tax-info" className="hover:text-white transition-colors">
                    Tax Information
                  </Link>
                </li>
              </ul>
